(() => {
  ...
  root.APServiceMPA = Object.freeze({ version: 'mpa-runtime-v6-supabase-auth-client', config: { url: SUPABASE_URL, publishableKey: SUPABASE_KEY }, request: lifecycle.request, requestCount: lifecycle.requestCount, network: lifecycle, STALE_RESPONSE, auth: { getSession, refreshSession, signIn, signInWithUsername, signUp, sendMagicLink, signInWithOAuth, sendPasswordRecovery, resetPassword, exchangeCodeForSession, verifyMagicLinkTokenHash, processCallback, acceptMagicLinkFromHash, acceptRecoveryFromHash, updatePassword, signOut, confirmSignOut, currentUser, hasStoredSession, sessionRestoreReady, rolesFor, customerRolesFor, requireRole, device: deviceAuth }, ui: { escapeHtml, baht, nowIso, loading, error, empty, setNotice, cooldownSubmit }, cart });
