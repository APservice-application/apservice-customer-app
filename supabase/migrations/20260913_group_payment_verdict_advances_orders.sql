-- A1: admin group-payment verdict now advances member orders (verify -> store accepted, reject -> reupload).
-- Before: orders stuck at payment review forever. E2E 2026-09-13.
...
BEGIN
  ...
  IF v_status = 'verified' THEN
    ...
    WHERE checkout_group_id = p_checkout_group_id AND status = 'รอตรวจสอบการชำระเงิน';
